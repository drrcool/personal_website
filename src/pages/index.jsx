...
import logoMMT from '@/images/logos/mmt.png'
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Get notified when I post a new article. You can unsubscribe at any time.
      </p>
...
function Resume() {
  let resume = [
    ...
    {
      company: 'Hubble Space Telescope',
      title: 'Hubble Fellow',
      logo: logoNasa,
      start: '2009',
      end: '2012'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Helping unleash the power of data with custom viz, analytic tooling, and medicitive modeling.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            achiving their goals through actioanable insights and predictive analytics.
          </p>
